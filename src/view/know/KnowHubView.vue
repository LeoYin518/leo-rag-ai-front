...
.el-table {
  border: 0;
  background:
    radial-gradient(circle at 100% 0%, rgba(34, 211, 238, 0.08), transparent 18rem),
    rgba(8, 13, 28, 0.48);
  box-shadow: 0 18px 46px rgba(0, 0, 0, 0.28), inset 0 0 0 1px rgba(103, 232, 249, 0.055);
...
.upload-demo {
  ...
  border-radius: 8px;
  background:
    radial-gradient(circle at 50% 0%, rgba(34, 211, 238, 0.10), transparent 18rem),
    linear-gradient(180deg, rgba(15, 23, 42, 0.76), rgba(8, 13, 28, 0.68));
  box-shadow: 0 18px 44px rgba(0, 0, 0, 0.28), inset 0 0 0 1px rgba(103, 232, 249, 0.045);
  ...
  :deep(.el-upload-dragger) {
    ...
    border: 0;
    background:
      radial-gradient(circle at center, rgba(34, 211, 238, 0.08), transparent 18rem),
      linear-gradient(180deg, rgba(15, 23, 42, 0.60), rgba(8, 13, 28, 0.56)) !important;
  ...
  :deep(.el-upload-dragger:hover) {
    box-shadow: inset 0 0 0 1px rgba(125, 249, 255, 0.16), 0 0 36px rgba(34, 211, 238, 0.12);
    transform: translateY(-1px);
  }

  :deep(.el-icon--upload) {
    color: #22d3ee;
    filter: drop-shadow(0 0 18px rgba(34, 211, 238, 0.32));
  }
...
.el-form {
  background:
    linear-gradient(180deg, rgba(15, 23, 42, 0.82), rgba(8, 13, 28, 0.72));
  padding: 16px;
  border: 0;
  border-radius: 8px;
  box-shadow: 0 18px 44px rgba(0, 0, 0, 0.28), inset 0 0 0 1px rgba(103, 232, 249, 0.055);
