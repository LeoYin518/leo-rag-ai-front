...
.word-frequency {
  ...
  .charts-container {
    ...
    .chart-item {
      background:
        radial-gradient(circle at 100% 0%, rgba(34, 211, 238, 0.10), transparent 12rem),
        linear-gradient(180deg, rgba(15, 23, 42, 0.82), rgba(8, 13, 28, 0.74));
      border: 0;
      border-radius: 8px;
      padding: 14px;
      box-shadow: 0 18px 44px rgba(0, 0, 0, 0.28), inset 0 0 0 1px rgba(103, 232, 249, 0.045), inset 0 1px 0 rgba(125, 249, 255, 0.025);
      position: relative;
      ...
      &::before {
        ...
        height: 1px;
        content: "";
        background: linear-gradient(90deg, transparent, rgba(125, 249, 255, 0.18), transparent);
      }
